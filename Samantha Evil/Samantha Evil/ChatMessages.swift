...
class ChatMessages: NSObject {
    ...
    public static func getMessagePack(pack: Int) -> [DialogueViewController.Dialogue] {
        ...
        case 1:
            messageArray = [
                DialogueViewController.Dialogue(dialogue: "I am glad you can help.",
                                                ...
                                                delay: 0.0,
                                                type: .message),
                DialogueViewController.Dialogue(dialogue: "Apprantly, Equifax - one of the largest credit bureaus in Canada",
                                                buttonA: nil,
                                                buttonB: nil,
                                                delay: 1.0,
                                                type: .message),
        ...
        case 7:
            messageArray = [
                DialogueViewController.Dialogue(dialogue: "So which wine did Samantha have?",
                                                buttonA: nil,
                                                buttonB: nil,
                                                delay: 0.0,
                                                type: .message),
                DialogueViewController.Dialogue(dialogue: "http://www.instagram.com",
                                                buttonA: DialogueViewController.Button(buttonLabel: "#Summerwine",
                                                                                       buttonAction: 8,
                                                                                       type: .nextMessages),
                                                buttonB: DialogueViewController.Button(buttonLabel: "#Merlon",
                                                                                       buttonAction: 999,
                                                                                       type: .nextMessages),
                                                delay: 1.0,
                                                type: .button)
        ...
        case 8:
            messageArray = [
                ...
                DialogueViewController.Dialogue(dialogue: "Samantha seems to be watching a movie with her friend right now",
                                                ...
                                                delay: 1.0,
                                                type: .message),
                DialogueViewController.Dialogue(dialogue: "Which movie is she watching? We might be able to catch her on the spot!",
                                                buttonA: nil,
                                                buttonB: nil,
                                                delay: 1.0,
                                                type: .message),
        ...
        case 9:
            messageArray = [
                DialogueViewController.Dialogue(dialogue: "http://www.facebook.com/samantha.eevil.399",
                                                buttonA: DialogueViewController.Button(buttonLabel: "Avengers Infinity War",
                                                                                       buttonAction: 12,
                                                                                       type: .nextMessages),
                                                buttonB: DialogueViewController.Button(buttonLabel: "Swordfish",
                                                                                       buttonAction: 999,
                                                                                       type: .nextMessages),
                                                delay: 0.0,
                                                type: .button)
        ...
        default:
            messageArray = [
                ...
                DialogueViewController.Dialogue(dialogue: "Hope you enjoyed your vacation, we are sorry to call you in",
                                                ...
                                                delay: 1.0,
                                                type: .message),
                DialogueViewController.Dialogue(dialogue: "We have a problem...",
                                                buttonA: nil,
                                                buttonB: nil,
                                                delay: 1.0,
                                                type: .message),
